      ...
      <div class="header-body">
        ...
        <div class="row">
          <div class="col-md-3 mb-3">
            <h1 class="display-4 text-white text-uppercase" style="border-bottom: 2px solid #fff;">Tambah Mahasiswa</h1>
          </div>
        </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group input-group-alternative mb-4">
                ...
                <input class="form-control form-control-alternative" placeholder="Masukan Nama " type="text" name="nama" required>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group input-group-alternative mb-4">
                ...
                <input class="form-control form-control-alternative" placeholder="Masukan Password " type="text" name="pass" required>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="form-group text-white">
              ...
              <div class="input-group input-group-alternative mb-4">
                ...
                <input class="form-control form-control-alternative" placeholder="Masukan Semester " type="text" name="kelas" required>
              </div>
            </div>
          </div>
          <div class="col-md-4">
