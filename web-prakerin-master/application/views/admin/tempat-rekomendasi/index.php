      ...
      <div class="header-body">
        <form action="<?php echo base_url('admin/tempatRekomendasi') ?>" method="post">
          <div class="row">
            ...
            <div class="col-md-5">
              <h1 class="display-4 text-white text-uppercase">Tabel Posisi</h1>
            </div>
            ...
            <div class="col-md-5 ml-5">
              <div class="form-group pr">
                <div class="input-group input-group-alternative mb-4">
                  ...
                  <input class="form-control form-control-alternative" placeholder="Cari posisi" type="text" name="cari" id="cari">
                </div>
              </div>
            </div>
