                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="input-group input-group-alternative mb-4">
                                    ...
                                    <input class="form-control form-control-alternative" placeholder=" posisi" type="text" name="pimpinan" data-toggle="popover" data-placement="top" data-content="Isi sesuai nama pimpinan perusahaan saat ini" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="input-group input-group-alternative mb-4">
                                    ...
                                    <input class="form-control form-control-alternative" placeholder=" Nama Pembing atau instruktur" type="text" name="pembimbing" data-toggle="popover" data-placement="top" data-content="Isi sesuai nama Pembing atau instruktur perusahaan saat ini" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
